    ...
    public class CN_Paypal
    {
        ...
        public async Task<Response_Paypal<Response_Checkout>> CrearSolicitud(Checkout_Order orden)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    string jsonResupuesta = response.Content.ReadAsStringAsync().Result;

                    Response_Checkout checkout =  JsonConvert.DeserializeObject<Response_Checkout>(jsonResupuesta);
        ...
        public async Task<Response_Paypal<Response_Capture>> AprobarPago(string token)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Response_Capture capture = JsonConvert.DeserializeObject<Response_Capture>(jsonResupuesta);
